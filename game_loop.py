...
def draw_screen(pantalla, background, personajes, width, height, image_width, image_height, marginBottom, margin=10):
    wander, seek, arrive, flee, wander2, clow, align, player = personajes
    ...
    clow_x = margin
    clow_y = height - image_height - marginBottom
...
def game_loop(pantalla, background, personajes, width, height, image_width, image_height, FPS):
    ...
    while running:
        ...
        draw_screen(pantalla, background, personajes, width, height, image_width, image_height, marginBottom)
        TIMER.tick(FPS)
